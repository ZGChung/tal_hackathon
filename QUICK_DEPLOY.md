...
3. Set these variables:
   ...
   - `ALLOWED_ORIGINS` = `https://tal-hackathon-frontend.onrender.com` (use your actual frontend URL)
...
2. Click **"Environment"** tab
3. Set this variable:
   - `REACT_APP_API_URL` = `https://tal-hackathon-backend.onrender.com` (use your actual backend URL)
4. Click **"Save Changes"**
