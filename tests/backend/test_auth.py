...
class TestUserRegistration:
    ...
    def test_register_student_success(self, client):
        ...
        response = client.post(
            "/api/auth/register",
            json={"username": "student1", "password": "password123", "role": "Student"},
        )
    ...
    def test_register_duplicate_username(self, client):
        ...
        client.post(
            "/api/auth/register",
            json={"username": "duplicate", "password": "pass123", "role": "Student"},
        )
        # Try to register again with same username
        response = client.post(
            "/api/auth/register",
            json={"username": "duplicate", "password": "pass456", "role": "Admin"},
        )
    ...
    def test_register_invalid_role(self, client):
        ...
        response = client.post(
            "/api/auth/register",
            json={"username": "user1", "password": "pass123", "role": "InvalidRole"},
        )
...
class TestUserLogin:
    ...
    def test_login_nonexistent_user(self, client):
        ...
        assert response.status_code == 401
        assert (
            "user" in response.json()["detail"].lower()
            or "invalid" in response.json()["detail"].lower()
        )
...
class TestJWTValidation:
    ...
    def test_get_current_user_success(self, client):
        ...
        client.post(
            "/api/auth/register",
            json={"username": "meuser", "password": "mepass123", "role": "Student"},
        )
        login_response = client.post(
            "/api/auth/login", json={"username": "meuser", "password": "mepass123"}
        )
...
class TestRoleBasedAccess:
    ...
    def test_admin_endpoint_requires_admin_role(self, client):
        ...
        login_response = client.post(
            "/api/auth/login",
            json={"username": "studentuser", "password": "studentpass"},
        )
    ...
    def test_admin_endpoint_allows_admin(self, client):
        ...
        login_response = client.post(
            "/api/auth/login", json={"username": "adminuser", "password": "adminpass"}
        )
